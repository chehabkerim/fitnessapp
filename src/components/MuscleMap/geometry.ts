// Solid muscle figure geometry (original drawing; design source: /design/muscle-figure/figure.mjs).
// Half-figure shapes left of x=100, mirrored at render. Every shape is filled; separations are strokes
// in the surface colour. viewBox 0 0 200 420.
...
export const SHAPES: Record<FigureView, { base: string[]; body: string[]; largeLines: string[]; regions: Partial<Record<Muscle, string>> }> = {
  front: {
